...
from legacy.component import LexicalParameters, UniformAlignment, JumpParameters, BrownDistortionParameters
from legacy.llcomp import LogLinearComponent
from legacy.event import LexEventSpace
from legacy.event import JumpEventSpace
from legacy.event import DistEventSpace
from legacy.fmatrix import make_dense_matrices, make_sparse_matrices
from legacy.corpus import Corpus
from legacy.model import DefaultModel
import logging
from legacy.ff import LexicalFeatureExtractor, JumpFeatureExtractor, DistortionFeatureExtractor
import sys
...
def read_extractor(e_corpus: Corpus, f_corpus: Corpus, args, line: str, i: int, state: Config):
    ...
    from legacy.ff import IBM1Probabilities, WholeWordFeatureExtractor, AffixFeatureExtractor
    from legacy.ff import CategoryFeatureExtractor, LengthFeatures
    from legacy.ff import JumpFeatureExtractor
